...
- `GET /api/v1/calculation-methods` — calculation settings accepted by those routes.
...
Set `OPENAPI_URL=https://api.aakashsharma.com.np/openapi.json` when synchronizing
